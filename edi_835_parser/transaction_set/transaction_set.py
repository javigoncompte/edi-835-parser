...
class TransactionSet:
    ...
    def serialize_service(
        ...
        datum = {
            ...
            'originating_company_id': reassociation_trace_number.originating_company_id,
            'check_eft': reassociation_trace_number.check_eft,
            'originating_company_tax_id' : reassociation_trace_number.originating_company_tax_id,
    ...
    def build(cls, file_path: str) -> 'TransactionSet':
        ...
        return TransactionSet(interchange, financial_information, reassociation_trace_number, claims, organizations)
